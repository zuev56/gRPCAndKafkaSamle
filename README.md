...
- FlightControlPanel берёт результаты анализа данных из FlightController (gRPC) и выводит их, запускает/останавливает RocketCoordGenerator и FlightController (REST)
